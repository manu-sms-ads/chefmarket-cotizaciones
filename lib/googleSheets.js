 ...
 * @param {boolean} [params.rutLegible] - false si el PDF no tenía capa de texto
 * @returns {Promise<void>}
 */
export async function appendRow({ contactData, rutData, rutFileName, rutLegible = true }) {
  ...
  const row = [
    ...
    rutFileName || '',
    camposExtraidos,
    rutLegible ? 'Pendiente revisión' : 'Requiere extracción manual del RUT',
  ];
